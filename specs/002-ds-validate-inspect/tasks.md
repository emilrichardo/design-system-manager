...
- [X] T028 [P] Implementar la **emisión de warnings/errors** restantes en el recorrido: `dtcg-empty-group` (grupo vacío), `dtcg-description-missing` (descripción ausente, warning), `dtcg-type-undeterminable` (sin tipo efectivo) en `src/infrastructure/analysis/traverse-dtcg-tree.ts`.
  - **Deps**: T027.
